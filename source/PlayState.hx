...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		DiscordClient.changePresence(SONG.song + " (" + storyDifficultyText + ") " + Ratings.GenerateLetterRank(accuracy), "\nAcc: " + HelperFunctions.truncateFloat(accuracy, 2) + "% | Score: " + songScore + " | Misses: " + misses  , iconRPC);
		#end
			...
			case 'black':
				{
						defaultCamZoom = 0.9;
						curStage = 'black';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('stage/black'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
	...
	override function closeSubState()
	{
		if (paused)
		{
			...
			{
				DiscordClient.changePresence(SONG.song + " (" + storyDifficultyText + ") " + Ratings.GenerateLetterRank(accuracy), iconRPC);
			}
			#end
		}
	...
	*/
	...
	override function stepHit()
	{
		...
		// Updating Discord Rich Presence (with Time Left)
		DiscordClient.changePresence(SONG.song + " (" + storyDifficultyText + ") " + Ratings.GenerateLetterRank(accuracy), "Acc: " + HelperFunctions.truncateFloat(accuracy, 2) + "% | Score: " + songScore + " | Misses: " + misses  , iconRPC,true,  songLength - Conductor.songPosition);
		#end
